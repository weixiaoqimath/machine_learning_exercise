...
class UNet(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        self.dconv_down1 = double_conv(3, 50)
        self.dconv_down2 = double_conv(50, 100)
        self.dconv_down3 = double_conv(100, 200)
        #self.dconv_down4 = double_conv(200, 400)

        self.maxpool = nn.MaxPool2d(2)
        self.upsample = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True)

        #self.dconv_up3 = double_conv(200 + 400, 200)
        self.dconv_up2 = double_conv(100 + 200, 100)
        self.dconv_up1 = double_conv(100 + 50, 50)

        self.conv_last = nn.Conv2d(50, n_class, 1)
